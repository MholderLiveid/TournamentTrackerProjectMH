...
public partial class MainForm : Form
{
    ...
    private void ActivateButton(object buttonSender)
    {
        if (buttonSender != null)
        {
            if (currentButton != (Button)buttonSender)
            {
                ...
                currentButton.BackColor = ColorCodes.ActiveButtonColor;
                currentButton.ForeColor = ColorCodes.FormFontColor;

                CloseCurrentFormButton.Visible = true;
            }
        }
    }
    ...
    private void DeactivateButton()
    {
        ...
        foreach (Control previousButton in panelMenu.Controls)
        {
            ...
            {
                previousButton.BackColor = ColorCodes.ButtonColor;
                previousButton.ForeColor = ColorCodes.FormFontColor;
            }
        }
    }
